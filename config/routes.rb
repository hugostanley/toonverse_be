...
#                                          GET|POST /oauth/:provider/callback(.:format)                                                               users/omniauth_callbacks#redirect_callbacks
#                            oauth_failure GET|POST /oauth/failure(.:format)                                                                          users/omniauth_callbacks#omniauth_failure
...
#                             auth_sign_in POST     /auth/sign_in(.:format)                                                                           devise_token_auth/sessions#create
