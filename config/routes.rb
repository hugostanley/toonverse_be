...
#                             auth_failure GET|POST /auth/failure(.:format)                                                                           users/omniauth_callbacks#omniauth_failure
#                                          GET|POST /auth/:provider/callback(.:format)                                                                users/omniauth_callbacks#omniauth_success
...
#                                          GET|POST /auth/:provider(.:format)                                                                         redirect(307)
...
#                           w_auth_failure GET|POST /w_auth/failure(.:format)                                                                         devise_token_auth/omniauth_callbacks#omniauth_failure
#                                          GET|POST /w_auth/:provider/callback(.:format)                                                              devise_token_auth/omniauth_callbacks#omniauth_success
#                                          GET|POST /omniauth/:provider/callback(.:format)                                                            devise_token_auth/omniauth_callbacks#redirect_callbacks
#                                          GET|POST /omniauth/failure(.:format)                                                                       devise_token_auth/omniauth_callbacks#omniauth_failure
#                                          GET|POST /w_auth/:provider(.:format)                                                                       redirect(307)
#                                          GET|POST /auth/:provider/callback(.:format)                                                                users/omniauth_callbacks#google_oauth2
