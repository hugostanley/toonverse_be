...
ActiveRecord::Schema[7.1].define(version: 2024_05_27_132751) do
  ...
  create_table "artworks", force: :cascade do |t|
    ...
    t.index ["workforce_id"], name: "index_artworks_on_workforce_id"
  end
  ...
  add_foreign_key "artworks", "workforces"
